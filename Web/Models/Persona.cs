...
namespace Web.Models
{
    public class Persona
    {
        ...
        public Persona(Int32 Dni, String nom, String pat, String mat)
        {
            dni = Dni;
            nombre = nom;
            apPaterno = pat;
        ...
        public static Models.Persona buscarDNI(Int32 dni)
        {

            return Convertir(Negocio.Persona.buscarDNI(dni));
        }
