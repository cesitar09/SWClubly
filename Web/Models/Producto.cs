...
namespace Web.Models
{
    public class Producto
    {
        ...
        {
            if(Negocio.Producto.insertar(ConvertirInverso(producto)) == null)
                return 1;
            else 
                return 0;
        }

        public static int modificarProducto(Models.Producto producto)
        {
            if (Negocio.Producto.modificar(ConvertirInverso(producto)) == null)
                return 1;
            else
                return 0;
        }
