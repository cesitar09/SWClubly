...
namespace Web.Models
{
    public class Empleado
    {
       ...
       // public Models.TurnoDeTrabajo turnodetrabajo { get; set; }
        ...
        //public IEnumerable<Models.Asistencia> asistencia { get; set; }
        //[DisplayName("Historial de Sedes")]
        //public IEnumerable<Models.EmpleadoXSede> empleadoxsede {get; set}
       // [DisplayName("Turnos")]
       ...
       [Required(ErrorMessage= " Seleccione una Sede" )]
        ...
        public Empleado(Datos.Empleado empleado)
        {
          ...
          //  id = empleado.id;
            ...
            //if(empleado.TurnoDeTrabajo!=null)
              //  turnodetrabajo = new TurnoDeTrabajo(empleado.TurnoDeTrabajo);
          //  usuario = new Usuario(empleado.Usuario);
            //asistencia = Models.Asistencia.ConvertirLista(empleado.Asistencia);
            //empleadoxsede = Models.EmpleadoXSede.ConvertirLista(empleado.EmpleadoXSede);
          //  empleadoxturno = Models.EmpleadoXTurno.ConvertirLista(empleado.EmpleadoXTurno);
            //ventas =  Models.Venta.ConvertirLista(empleado.Venta);
        ...
        public static Datos.Empleado Invertir(Models.Empleado empleado)
        {
            ...
            //if (Dempleado.TurnoDeTrabajo != null)
            //    Dempleado.TurnoDeTrabajo = Models.TurnoDeTrabajo.Invertir(empleado.turnodetrabajo);
            ...
            //Dempleado.Sede.Empleado.Add(Dempleado);
            return Dempleado;
        }
        ...
        public static int insertar(Models.Empleado empleado)
        {
           ...
           return Negocio.Empleado.insertar(Invertir(empleado));
        }
        public static void modificar(Models.Empleado emp, Models.Empleado empleado)
        {
           ...
           // e.Persona.estado = empleado.persona.estado;
            ...
            e.Sede = Negocio.Sede.buscarId(emp.sede.id);
            e.TipoEmpleado = Negocio.TipoEmpleado.buscarId(emp.tipoEmpleado.id);
