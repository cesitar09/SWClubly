...
namespace Web.Models
{
    public class EmpleadoXTurno
    {
        ...
        public static Datos.EmpleadoXTurno Invertir(Models.EmpleadoXTurno empxturno)
        {
            ...
            dempxturno.idEmpleado = empxturno.empleado.persona.id;
            dempxturno.idTurnoDeTrabajo = empxturno.turnodetrabajo.id;
        ...
        public  static int insertar(Models.EmpleadoXTurno empxturno)      
        {
            return Negocio.EmpleadoXTurno.insertar(Invertir(empxturno));
        }
